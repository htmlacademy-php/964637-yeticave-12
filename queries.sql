...
-- Добавляем фктивные лоты
INSERT INTO lots (dt_add, completion_dt, title, description, image, starting_price, bet_step, author_id, category_id)
VALUES (CURRENT_TIMESTAMP - interval 1 WEEK, CURRENT_TIMESTAMP + interval 1 WEEK, '2014 Rossignol District 
Snowboard', 'Легкий маневренный сноуборд', 'img/lot-1.jpg', 10999, 500, 1, 1),
